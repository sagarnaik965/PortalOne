                            ...
                            <div class="row">
                                <div class="col-lg-8 col-lg-offset-2">
                                 <c:choose>
                                    ...
                                    <form:form role="form"  method="POST" action="getref" id="getref" modelAttribute="getref">
                                    <input type="hidden"                       
		name="${_csrf.parameterName}"	value="${_csrf.token}"/>
                                        <div class="form-group">
                                            <label>Enter UID Number<font color="red">*</font> </label>
                                            <input type="text" name="getREF" id="getREF" placeholder="UID Number" class="form-control"/>
											<span><form:errors path="storeuid" cssClass="error"/></span>
                                        </div>
                                        <div align="center">
										<button style="margin-right:90px" tpe="submit" class="btn btn-primary">Get Reference Number</button>
                                        </div>
                                    </form:form>
                                </div>
