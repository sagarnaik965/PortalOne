		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form action="generateschemecode" id="frm-example" method="post">
						...
						<table id="example" width="100%"
							...
							<!-- <thead>
								<tr>
									...
									<th> Generate Scheme Code</th>
								</tr>
							</thead> -->
							<thead>
							<tr>
								<th>
							 		Application Code <select id="schemecode" name="schemecode">
							 		<c:forEach var="appcode" items="${appcode}" >
							 		<option value="${appcode.auaCode}">${appcode.auaCode}</option>
								 	</c:forEach>
							 		</select>
							 	</th>
							 	<th>Schema Description <input type="text" id="desc" name="desc">
							 	</th>
