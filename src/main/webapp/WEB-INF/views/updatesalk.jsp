		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form action="updatesalk" id="frm-example" method="post">
						<table id="example" width="100%"
							...
							<thead>
								<tr>
									...
									<th>Access Code</th>
									<th style="width: 305px;">License Key</th>
									<th>Validity</th>
								</tr>
							</thead>
...
<c:url value="/resources/js/update_saLK.js" var="jsfile" />
