                            ...
                            <div class="row">
                                <div class="col-lg-8 col-lg-offset-2">
                                 <c:choose>
                                    ...
                                    <form:form role="form"  method="POST" name="updateaccountpassword" id="updateaccountpassword" action="updaterecovepassword" modelAttribute="accountactivationdetails">
                                       <input type="hidden"                        6
...
<!--                                             <p class="help-block">Confirm your new password.</p> -->
                                        ...
                                        <form:input  type="hidden" id="userName" path ="userName" name="userName" value="${user} "  />
